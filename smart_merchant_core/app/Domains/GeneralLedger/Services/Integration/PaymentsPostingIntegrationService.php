...
class PaymentsPostingIntegrationService
{
    ...
    public function handlePaymentsPostingRequest(PostingRequestDTO $request, string $userId): void
    {
        $data = [
            'business_id' => $request->businessId,
            'fiscal_year_id' => Str::uuid()->toString(),
            'fiscal_period_id' => Str::uuid()->toString(),
            'journal_number' => 'PAY-' . strtoupper(Str::random(6)),

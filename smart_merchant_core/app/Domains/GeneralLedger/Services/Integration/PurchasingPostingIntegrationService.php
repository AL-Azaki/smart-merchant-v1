...
class PurchasingPostingIntegrationService
{
    ...
    public function handlePurchasingPostingRequest(PostingRequestDTO $request, string $userId): void
    {
        $data = [
            'business_id' => $request->businessId,
            'fiscal_year_id' => Str::uuid()->toString(),
            'fiscal_period_id' => Str::uuid()->toString(),
            'journal_number' => 'PUR-' . strtoupper(Str::random(6)),
            'document_date' => $request->date,
            'journal_type' => 'PurchaseInvoice',

...
void main() {
  group('SalesCalculator Business Logic Tests -', () {
    test(
      'يجب أن يعالج مشكلة الفواصل العشرية (Floating Point Precision) بشكل صحيح',
      () {
        // في البرمجة العادية: 10.99 * 3 = 32.970000000000006
        final items = [SalesItem(quantity: 3, unitPrice: 10.99)];
    ...
    test(
      'يجب أن يحسب الضريبة بشكل قانوني بعد خصم جميع التخفيضات (النسبة المئوية)',
      () {
        final items = [
          SalesItem(
            quantity: 2,

    ...
    test('login success updates state to authenticated', () async {
      ...
      when(() => mockApi.bootstrap(any())).thenAnswer(
        (_) async => const BootstrapResponseDto(
          ...
          activeBusiness: BusinessDto(id: 'b1', businessName: 'Test Business', businessType: 'Retail'),
          activeBranch: BranchDto(id: 'br1', branchName: 'Test Branch', isActive: true),
          availableBusinesses: [],
          allowedBranches: [BranchDto(id: 'br1', branchName: 'Test Branch', isActive: true)],
          roles: ['Admin'],
          permissions: [],
        ),
      );

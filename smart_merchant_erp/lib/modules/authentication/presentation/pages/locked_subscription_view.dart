...
class LockedSubscriptionView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<LockedSubscriptionView> createState() =>
      _LockedSubscriptionViewState();
}

class _LockedSubscriptionViewState
    extends ConsumerState<LockedSubscriptionView> {
  ...
  final List<Map<String, dynamic>> _plans = [
    ...
    },
    {
      ...
      'features': [
        'فروع غير محدودة',
        'مستخدمين غير محدود',
        'جميع الأنظمة والتقارير المتقدمة',
      ],
      'isPopular': false,
    },
  ];
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    'نأمل أن تكون قد استمتعت بتجربتك. يرجى تجديد الاشتراك للاستمرار في استخدام النظام.',
      ...
      builder: (ctx) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            const Text(
              'تأكيد الاشتراك (تحويل بنكي)',
              style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
            ),
            const SizedBox(height: 8),
            const Text(
              'يرجى تحويل المبلغ المطلوب إلى أحد الحسابات التالية، ثم اضغط على "تأكيد إرسال الطلب".',
              textAlign: TextAlign.center,
              style: TextStyle(
            ...
            ElevatedButton(
              ...
              child: const Text(
                'قمت بالتحويل، أرسل الطلب للإدارة',
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 15,
                  fontWeight: FontWeight.bold,

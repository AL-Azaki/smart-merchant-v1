...
class _PaymentModalState extends ConsumerState<PaymentModal> {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isValidToPay =
        !hasCredit || (hasCredit && posState.customerName != null);
          ...
          Expanded(
            child: LayoutBuilder(
              builder: (context, constraints) {
                ...
                final summarySection = _buildSummarySection(
                  posState,
                  total,
                  isDark,
                  textColor,
                    ...
                    child: Column(
                      children: [
                        ...
                        Divider(
                          ...
                          color: borderColor,
                          thickness: 8,
                        ), // Thick divider between sections on mobile
                        paymentSection,
                      ],
                    ),
                  );
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  '${posState.totals.rawSubtotal.toStringAsFixed(2)}',
                  style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: 14,
                    color: textColor,
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  '${posState.totals.taxTotal.toStringAsFixed(2)}',
                  style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: 14,
                    color: textColor,
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            padding: const EdgeInsets.all(16),
            decoration: BoxDecoration(
              color: posState.customerName == null && hasCredit
          ...
          const SizedBox(height: 32),
          ElevatedButton(
            onPressed: (!isValidToPay || posState.isSubmitting)
                ? null
                : () {
                    ref
                        ...
                        .submitSale(
                          ...
                          paymentMethodId:
                              'CASH', // In real life, resolved from payment method selector
                        );
                  },
            style: ElevatedButton.styleFrom(
              backgroundColor: AppColors.primary,
              ...
              elevation: isValidToPay && !posState.isSubmitting ? 8 : 0,

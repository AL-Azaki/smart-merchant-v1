...
class SalesCalculator {
  ...
  static InvoiceTotals calculate({
    ...
    if (isGlobalDiscountPercentage) {
      globalDiscountAmount = _roundToCents(
    ...
    double totalDiscount = _roundToCents(
      itemsDiscountTotal + globalDiscountAmount,
    );
    ...
    for (var item in items) {
      ...
      double lineGlobalDiscount = _roundToCents(
        globalDiscountAmount * lineWeight,
      );

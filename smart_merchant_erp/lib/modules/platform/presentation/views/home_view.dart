...
class HomeView extends StatelessWidget {
              ...
              children: [
                _buildStatWrapper(
                  StatCard(
                    ...
                    value: '---', // Pending backend aggregation
  ...
  Widget _buildQuickActionCard(
    ...
    final iconColor = (isDark && baseColor == AppColors.primary)
        ? AppColors.primaryLight
        : baseColor;

          ...
          return pw.Column(
            ...
            children: [
              ...
              pw.Row(
                ...
                children: [pw.Text('رقم الفاتورة:'), pw.Text(invoiceNumber)],
              ),
              pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [pw.Text('العميل:'), pw.Text(customerName)],
              ),
              pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [pw.Text('التاريخ:'), pw.Text(date)],
              ),
